...
.ECBlock-markdownSetting select {\r
...
.ECBlock-actions > div.ECBlock-markdownButton.ECBlock-active {\r
  color: var(--status-positive);\r
}\r
...
.ECBlock-modal {\r
  /* No max-height constraint - let it grow with dynamic size */\r
  max-width: 66rem;\r
}\r
.ECBlock-modal .ECBlock-wrapper {\r
  /* Allow wrapper to grow with content */\r
  max-height: none;\r
}\r
/* Make Discord's dynamic modal wider for our content (height handled via ref) */\r
[class*="layer-"] > [class*="content-"]:has(.ECBlock-modal) {\r
  width: 100vw !important;\r
  max-width: 66rem !important;\r
}\r
.ECBlock-markdown {\r
  padding: 16px;\r
  color: #dcddde;\r
...
.ECBlock-markdown h1, .ECBlock-markdown h2, .ECBlock-markdown h3,\r
.ECBlock-markdown h4, .ECBlock-markdown h5, .ECBlock-markdown h6 {\r
  color: #ffffff;\r
  margin-top: 1.2em;\r
  margin-bottom: 0.6em;\r
  font-weight: 600;\r
}\r
.ECBlock-markdown h1 {\r
  font-size: 1.5em;\r
  border-bottom: 1px solid #42454a;\r
  padding-bottom: 0.3em;\r
}\r
.ECBlock-markdown h2 {\r
  font-size: 1.3em;\r
  border-bottom: 1px solid #42454a;\r
  padding-bottom: 0.3em;\r
}\r
.ECBlock-markdown h3 {\r
  font-size: 1.1em;\r
}\r
.ECBlock-markdown code {\r
  background: #2b2d31;\r
  padding: 2px 6px;\r
  border-radius: 4px;\r
  font-family: var(--font-code);\r
...
.ECBlock-markdown pre code {\r
  background: transparent;\r
  padding: 0;\r
}\r
.ECBlock-markdown blockquote {\r
  border-left: 4px solid #4f545c;\r
  padding-left: 16px;\r
  margin: 12px 0;\r
  color: #b9bbbe;\r
}\r
.ECBlock-markdown a {\r
  color: #00aff4;\r
  text-decoration: none;\r
}\r
.ECBlock-markdown a:hover {\r
  text-decoration: underline;\r
}\r
.ECBlock-markdown ul, .ECBlock-markdown ol {\r
  padding-left: 24px;\r
  margin: 8px 0;\r
}\r
.ECBlock-markdown li {\r
  margin: 4px 0;\r
}\r
.ECBlock-markdown table {\r
  border-collapse: collapse;\r
  width: 100%;\r
  margin: 12px 0;\r
}\r
.ECBlock-markdown table th {\r
  background: #2b2d31;\r
  border: 1px solid #42454a;\r
  padding: 8px 12px;\r
  text-align: left;\r
  color: #ffffff;\r
}\r
.ECBlock-markdown table td {\r
  border: 1px solid #42454a;\r
  padding: 8px 12px;\r
}\r
.ECBlock-markdown img {\r
  max-width: 100%;\r
  border-radius: 8px;\r
}\r
.ECBlock-markdown hr {\r
  border: none;\r
  border-top: 1px solid #42454a;\r
  margin: 16px 0;\r
}\r
.ECBlock-markdown input[type="checkbox"] {\r
  margin-right: 8px;\r
  cursor: default;\r
}\r
.ECBlock-markdown li.task-list-item {\r
  list-style-type: none;\r
}\r
.ECBlock-markdown del {\r
...
function useStateDeps(initialState, deps) {
  ...
  return (
    (0, import_react.useLayoutEffect)(() => setState(initialState), deps),
    [state, setState]
  );
}
var import_react,
...
var require_highlight = __commonJS({
  "shim-highlight.js:highlight.js"(exports2) {
    var module2 = BdApi.Webpack.getModule(
      (m) => m.highlight && m.listLanguages,
    );
    Object.assign(exports2, module2);
    "default" in module2 || Object.assign(exports2, { default: module2 });
  },
...
var require_marked = __commonJS({
  "shim-marked:marked"(exports2) {
    // Try to get from global window object (if loaded by CDN)
    if (window.marked) {
      Object.assign(exports2, window.marked);
      "default" in window.marked ||
        Object.assign(exports2, { default: window.marked });
      return;
    }
    // If not available, create a minimal marked parser
    // This is a fallback that provides basic markdown functionality
    var marked = {
      parse: function (text, options) {
        ...
        html = html.replace(/((?:\|[^\n]+\|\n?)+)/g, function (match) {
          ...
          var isTable = rows.every(function (row) {
          ...
          for (var i = 0; i < rows.length; i++) {
            var isHeader =
              i === 0 || (i === 1 && rows[i].indexOf("|---") !== -1);
            if (i === 1 && rows[i].indexOf("|---") !== -1) continue;
        ...
        html = "<p>" + html + "</p>";
        // Cleanup
        html = html.replace(/<p><(h[1-6]|table|blockquote|ul|pre|hr)/g, "<$1");
        html = html.replace(
          /<\/(h[1-6]|table|blockquote|ul|pre)><\/p>/g,
          "</$1>",
        );
        html = html
          .replace(/<p><li>/g, "<li>")
...
function useData(key, presetValue) {
  let [state, setState] = (0, import_react3.useState)(() =>
      getData(key, presetValue),
    ),
    updateState = (0, import_react3.useCallback)(
      (state2) => {
        (setState(state2), setData(key, state2));
        let set = listeners.get(key);
        set || (set = /* @__PURE__ */ new Set());
        for (let listener of set) listener();
      },
      [state],
    );
  return (
...
[Download to view the rest of this file]`
          : content;
    return import_highlight.default.getLanguage(lang)
      ? import_highlight.default.highlight(_content, { language: lang })
      : import_highlight.default.highlight(_content, { language: _lang });
...
function useSizing(collapsed, tableRef, modal, content, lang, showPreview) {
  let [maxHeight] = useData("maxHeight", 300),
    [previewHeight] = useData("previewHeight", 200),
    [instantCollapse] = useData("instantCollapse", !1),
    ref = (0, import_react4.useRef)(!1),
    [tableHeight, setTableHeight] = (0, import_react4.useState)(0),
    { height, angle } = import_react_spring.default.useSpring({
      config: ref.current
        ? instantCollapse
          ? { duration: 0 }
          : import_react_spring.default.config.default
        : { duration: 0 },
  ...
  return (
    (0, import_react4.useLayoutEffect)(() => {
      if (((ref.current = !1), modal)) {
        ...
        let { height: height2 } = getComputedStyle(
            tableRef.current.parentElement,
            "::-webkit-scrollbar",
          ),
          match = height2.match(/([0-9]+)(.*)/),
          scrollerHeight;
        try {
          if (match) {
            ...
            if (!CSS[length])
              ...
              css
                ? (scrollerHeight = css.to("px").value)
                : (scrollerHeight = Number(height2.replace("px", "")));
            }
          } else scrollerHeight = Number(height2.replace("px", ""));
        } catch {
          scrollerHeight = Number(height2.replace("px", ""));
        }
        ...
        (tableRef.current.parentElement.scroll({ left: 0 }),
          setTableHeight(
            ...
            Math.min(
              (add
                ? scrollerHeight + tableRef.current.offsetHeight
                : tableRef.current.offsetHeight) + 2,
              maxHeight,
            ),
          ));
...
var import_highlight,
  import_react4,
  import_react_spring,
  init_codeblock = __esm({
    "src/hooks/codeblock.ts"() {
      "use strict";
      ((import_highlight = __toESM(require_highlight())),
        (import_react4 = __toESM(require_react())),
        (import_react_spring = __toESM(require_react_spring())));
      init_util();
      init_data();
    },
  });
      ...
      return (
        (async () => {
          ...
          if (result.ok) {
            ...
            setContent(
              `Enhance Codeblocks FETCH ERROR: STATUS=${JSON.stringify(result.status)} OK=${JSON.stringify(result.ok)} URL=${JSON.stringify(result.url)}`,
            );
        })(),
...
function Icon({ size, name }) {
  let Icon2 = (0, import_react6.useMemo)(
    () => (icons[name] ? icons[name] : icons.error),
    [name],
  );
      ...
      ((import_react6 = __toESM(require_react())),
        (icons = {
          ...
          github({ width, height }) {
            return BdApi.React.createElement(
              "svg",
              { viewBox: "0 0 24 24", fill: "currentColor", width, height },
              BdApi.React.createElement("path", {
...
function SettingItem({ title, disabled, hideBorder, item, note }) {
  return BdApi.React.createElement(
    ...
    BdApi.React.createElement(
      ...
      BdApi.React.createElement("label", { className: classes.title }, title),
      BdApi.React.createElement("div", { className: classes.control }, item),
    ),
    note &&
      BdApi.React.createElement(
        Text,
        {
          className: `${noteClasses.description} ${noteClasses.modeDefault}${disabled ? ` ${noteClasses.modeDisabled}` : ""}`,
        },
        note,
      ),
    !hideBorder &&
      BdApi.React.createElement(Divider, { className: classes.dividerDefault }),
  );
}
var import_react7,
  classes,
  ...
  init_settingsItem = __esm({
    "src/components/settingsItem.tsx"() {
      "use strict";
      ((import_react7 = __toESM(require_react())),
        (classes = BdApi.Webpack.getModule(
          (m) => m.container && m.dividerDefault,
        )),
        (noteClasses = BdApi.Webpack.getModule(
          (m) => m.description && m.modeDefault,
        )),
        (Divider = BdApi.Webpack.getModule(
          BdApi.Webpack.Filters.byStrings("),style:", ".divider,"),
          { searchExports: !0 },
        )),
...
var import_react8,
  ...
  Popout,
  ErrorBoundary,
  init_components = __esm({
    "src/components/index.tsx"() {
      "use strict";
      import_react8 = __toESM(require_react());
      init_icon();
      init_settingsItem();
      ((ModalRoot = BdApi.Webpack.getByStrings(
        "reducedMotion:",
        "transitionState:",
        "small",
        "dialog",
        ...
        (Spinner = BdApi.Webpack.getModule((m) => m.Type?.PULSING_ELLIPSIS, {
          searchExports: !0,
        })),
        (foundToolTip = BdApi.Webpack.getModule(
          (m) =>
            m.prototype?.setDomElement &&
            m.prototype.render.toString().includes("renderTooltip()"),
          { searchExports: !0 },
        )),
        (Tooltip = foundToolTip || BdApi.Components.Tooltip),
        (Switch = BdApi.Webpack.getModule(
          BdApi.Webpack.Filters.byStrings("focusProps:", ",tooltipNote:"),
          { searchExports: !0 },
        )),
        (Popout = BdApi.Webpack.getModule(
          (m) => m.prototype?.render?.toString().includes("shouldShowPopout"),
          { searchExports: !0 },
        )),
        (ErrorBoundary = class extends import_react8.default.Component {
          state = { hasError: !1 };
          componentDidCatch() {
          ...
          render() {
            return this.state.hasError
              ? BdApi.React.createElement(
                  "div",
                  { className: "ECBlock ECBlock-error" },
                  BdApi.React.createElement(
                    "div",
                    {
...
function getContent(searchValue) {
  return LANGUAGES.map(({ value, aliases, lang }) => ({
    component: BdApi.React.createElement(
      SearchItem,
      { key: value, value },
      BdApi.React.createElement(SearchItem.Label, null, lang.name),
    ),
    aliases,
  }))
    .filter(({ aliases }) =>
      aliases.find((alias) =>
        alias.toLowerCase().includes(searchValue.toLocaleLowerCase()),
      ),
    )
...
var import_react9,
  ...
  LANGUAGES,
  changeLang_default,
  init_changeLang = __esm({
    "src/codeblock/changeLang.tsx"() {
      "use strict";
      ((import_react9 = __toESM(require_react())),
        (import_highlight2 = __toESM(require_highlight())));
      init_util();
      ((SearchPopout = BdApi.Webpack.getModule(
        (m) => m.toString?.().includes('4o4z3e"]'),
        { searchExports: !0 },
      )),
        (SearchItem = BdApi.Webpack.getModule(
          (m) => m.Checkbox && m.Checkmark,
          { searchExports: !0 },
        )),
        ({ languageSelector } = BdApi.Webpack.getModule(
          (m) => m.languageSelector && m.fileName,
        )),
        (LANGUAGES = import_highlight2.default.listLanguages().map((name) => {
...
function Header({
  ...
  let [shouldShow, setShouldShow] = import_react10.default.useState(!1),
    targetElementRef = import_react10.default.useRef(null),
    formattedBytes = (0, import_react10.useMemo)(
      () => formatBytes(bytes),
      [bytes],
    );
  return BdApi.React.createElement(
    "div",
    { className: "ECBlock-header" },
    BdApi.React.createElement(
      "div",
      { className: "ECBlock-title" },
      !modal &&
        BdApi.React.createElement(
          import_react_spring2.default.animated.div,
          {
            style: {
              transform: angle.to({
          ...
          BdApi.React.createElement(
            Tooltip,
            { text: collapsed ? "Collapsed" : "Uncollapse", hideOnClick: !1 },
            (props) =>
              BdApi.React.createElement(
                "div",
                {
                  className: "ECBlock-collapse",
                  ...props,
                  onClick: () => setCollapsed(!collapsed),
                },
                BdApi.React.createElement(icon_default, {
                  size: 22,
                  name: "arrow",
                }),
              ),
      ...
      BdApi.React.createElement(
        Popout,
        {
          targetElementRef,
          renderPopout: () =>
            BdApi.React.createElement(changeLang_default, {
              value: languageName,
              onChange: (value) => {
      ...
      !loading &&
        BdApi.React.createElement(
          Tooltip,
          { text: `${bytes} B`, hideOnClick: !1 },
          (props) =>
            BdApi.React.createElement(
              "div",
              { className: "ECBlock-byteSize", ...props },
              formattedBytes,
            ),
        ),
    ),
    BdApi.React.createElement(
      "div",
      { className: "ECBlock-actions" },
      remove &&
        BdApi.React.createElement(
          Tooltip,
          { text: message("oyYWHE"), hideOnClick: !1 },
          (props) =>
            BdApi.React.createElement(
              "div",
              { className: "ECBlock-remove", ...props, onClick: remove },
              BdApi.React.createElement(icon_default, {
                size: 22,
                name: "trash",
              }),
      ...
      isSVG &&
        BdApi.React.createElement(
          Tooltip,
          { text: "Preview", hideOnClick: !1 },
          (props) =>
            BdApi.React.createElement(
              "div",
              {
                className: `ECBlock-previewButton${showPreview ? " ECBlock-active" : ""}`,
                ...props,
      ...
      isMarkdown &&
        BdApi.React.createElement(
          ...
          {
            text:
              markdownViewMode === "rendered" ? "View Code" : "View Rendered",
            hideOnClick: !1,
          },
          (props) =>
            BdApi.React.createElement(
              "div",
              {
                className: `ECBlock-markdownButton${markdownViewMode === "rendered" ? " ECBlock-active" : ""}`,
                ...props,
                onClick: () =>
                  setMarkdownViewMode(
                    markdownViewMode === "rendered" ? "raw" : "rendered",
                  ),
              },
              BdApi.React.createElement(icon_default, {
                size: 22,
                name: markdownViewMode === "rendered" ? "copy" : "eye",
              }),
            ),
        ),
      BdApi.React.createElement(
        Tooltip,
        { text: message("1WjMbC"), hideOnClick: !1 },
        (props) =>
          BdApi.React.createElement(
            "div",
            {
              className: "ECBlock-downloadButton",
              ...props,
      ...
      BdApi.React.createElement(
        Tooltip,
        {
          text: copied ? message("t5VZ88") : message("OpuAlK"),
          hideOnClick: !1,
        },
        (props) =>
          BdApi.React.createElement(
            "div",
            {
              className: `ECBlock-copyButton${copied ? " ECBlock-copied" : ""}`,
              ...props,
              onClick: copyAction,
            },
            BdApi.React.createElement(icon_default, { size: 22, name: "copy" }),
          ),
      ),
      !modal &&
        BdApi.React.createElement(
          Tooltip,
          { text: message("0PQYk3"), hideOnClick: !1 },
          (props) =>
            BdApi.React.createElement(
              "div",
              {
                className: "ECBlock-enlarge",
                ...props,
...
var import_react10,
  import_react_spring2,
  header_default,
  init_header = __esm({
    "src/codeblock/header.tsx"() {
      "use strict";
      ((import_react10 = __toESM(require_react())),
        (import_react_spring2 = __toESM(require_react_spring())));
      init_components();
      init_changeLang();
      init_util();
      ...
      propHandlers = {
        Diff(line, props) {
          let match = line.match(
            /<span class="hljs-(deletion|addition)">(.*?)<\/span>/,
          );
...
function Line({ index, language, line }) {
  let props = (0, import_react11.useMemo)(
    () => handler_default(language, line),
    [language, line],
  );
  return BdApi.React.createElement(
    "tr",
    { className: "ECBlock-row" },
    BdApi.React.createElement("td", { className: "ECBlock-index" }, index + 1),
    BdApi.React.createElement("td", { ...props }),
  );
}
var import_react11,
  line_default,
...
function Code({ highlighted, tableRef, language }) {
  let spl = (0, import_react12.useMemo)(
    () =>
...
`),
  ...
  return BdApi.React.createElement(
    "table",
    { className: "ECBlock-table", ref: tableRef },
    BdApi.React.createElement(
      "tbody",
      null,
      spl.map((line, index) =>
        BdApi.React.createElement(line_default, {
          key: `${line}__${index}`,
          index,
          line,
          language,
...
function MarkdownRenderer({ content }) {
  // Use marked library for comprehensive markdown parsing
  var md = import_marked.default.parse(content, {
...
var import_react_md,
  ...
  init_markdown = __esm({
    "src/codeblock/markdown.tsx"() {
      "use strict";
      import_react_md = __toESM(require_react());
      import_marked = __toESM(require_marked());
      markdown_default = (0, import_react_md.memo)(MarkdownRenderer);
    },
  });
...
function Preview({ height, src }) {
  return BdApi.React.createElement(
    "div",
    { className: "ECBlock-preview" },
    BdApi.React.createElement("img", { src, height }),
  );
}
var import_react13,
  preview_default,
...
function CodeBlock({ content, lang, modal, fileName, loading = !1, remove }) {
  let tableRef = (0, import_react14.useRef)(null),
    modalRootRef = (0, import_react14.useRef)(null),
    [_lang, setLang] = useStateDeps(lang, [lang]),
    [autoCollapse] = useData("autoCollapse", !1),
    [collapsed, setCollapsed] = useStateDeps(
      () => (modal ? !1 : autoCollapse),
      [autoCollapse],
    ),
    language = useLanguage(_lang),
    highlighted = useHighlighted(language, _lang, content),
    [showPreview, setShowPreview] = (0, import_react14.useState)(!1),
    [previewHeight] = useData("previewHeight", 200),
    { height, angle } = useSizing(
      collapsed,
      tableRef,
      modal,
      content,
    ...
    src = useSrc(content),
    isSVG = (0, import_react14.useMemo)(
      () => lang === "svg" && language.name === "HTML, XML" && Boolean(src),
      [lang, language, src],
    ),
    downloadAction = (0, import_react14.useCallback)(() => {
      loading ||
        (window.DiscordNative &&
          window.DiscordNative.fileManager.saveWithDialog(content, fileName()));
    }, [content, lang, loading]),
    [copied, setCopied] = (0, import_react14.useState)(!1),
    setCopiedFalse = (0, import_react14.useMemo)(
      () => debounce(() => setCopied(!1), 2e3),
      [],
    ),
    copyAction = (0, import_react14.useCallback)(() => {
      loading ||
        (window.DiscordNative && window.DiscordNative.clipboard.copy(content),
        setCopied(!0),
        setCopiedFalse());
    }, [content, copied, loading]),
    enlargeAction = (0, import_react14.useCallback)(() => {
      loading ||
        openModal(({ transitionState }) =>
          BdApi.React.createElement(
            ModalRoot,
            { transitionState, size: "dynamic" },
            BdApi.React.createElement(CodeBlock, {
              content,
              lang,
              modal: !0,
              fileName,
    ...
    byteSize = (0, import_react14.useMemo)(
      () => new File([content], "").size,
      [content],
    ),
    [wrapText] = useData("wrapText", !1),
    isMarkdown = (0, import_react14.useMemo)(() => {
      let mdLangs = ["md", "markdown", "mdx"];
      return mdLangs.includes((lang || "").toLowerCase());
    }, [lang]),
    [markdownViewMode, setMarkdownViewMode] = useData(
      "markdownViewMode",
      "rendered",
    );
  // Override Discord's modal height constraint in modal mode
  (0, import_react14.useEffect)(() => {
    if (modal && modalRootRef.current) {
      const walkUpAndSetHeight = (element) => {
        let current = element;
        while (current && current !== document.body) {
          // Check for Discord modal container by class name pattern
          if (current.classList) {
            for (let cls of current.classList) {
              if (cls.includes("modal") || cls.includes("content")) {
                current.style.maxHeight = "92vh";
                current.style.height = "92vh";
                return true;
              }
            }
          }
      ...
      walkUpAndSetHeight(modalRootRef.current);
  ...
  return BdApi.React.createElement(
    ...
    BdApi.React.createElement(header_default, {
      angle,
      collapsed,
      setCollapsed,
      languageName: `${isSVG ? "SVG, " : ""}${isMarkdown ? "Markdown, " : ""}${language.name}`,
      isSVG,
      isMarkdown,
      showPreview,
      setShowPreview,
    ...
    BdApi.React.createElement(
      import_react_spring3.default.animated.div,
      {
        className: `ECBlock-wrapper ${thin}`,
        style: modal ? { height: "calc(92vh - 44px)" } : { height },
      },
      loading &&
        BdApi.React.createElement(Spinner, {
          type: Spinner.Type.WANDERING_CUBES,
        }),
      !loading &&
        showPreview &&
        isSVG &&
        BdApi.React.createElement(preview_default, {
          src,
          height: modal ? 600 : previewHeight,
        }),
      !loading &&
        isMarkdown &&
        markdownViewMode === "rendered" &&
        BdApi.React.createElement(markdown_default, { content }),
      !loading &&
        !(
          (showPreview && isSVG) ||
          (isMarkdown && markdownViewMode === "rendered")
        ) &&
        BdApi.React.createElement(table_default, {
          highlighted,
          tableRef,
          language,
        }),
...
var import_react14,
  import_react_spring3,
  thin,
  openModal,
  codeblock_default,
  init_codeblock2 = __esm({
    "src/codeblock/index.tsx"() {
      "use strict";
      ((import_react14 = __toESM(require_react())),
        (import_react_spring3 = __toESM(require_react_spring())));
      init_hooks();
      init_header();
      init_table();
      init_preview();
      ...
      init_data();
      init_util();
      (({ thin } = BdApi.Webpack.getModule((m) => m.thin && m.none)),
        (openModal = BdApi.Webpack.getMangled(
          "?.stackNextByDefault",
          {
            openModal: BdApi.Webpack.Filters.byStrings("?.stackNextByDefault"),
            closeModal: BdApi.Webpack.Filters.byStrings(
              ".setState",
              ".getState()[",
            ),
...
function AttachmentWrapper({
  ...
  let content = useFetchContent(item.originalItem.url),
    lang = (0, import_react15.useMemo)(() => {
      let spl = item.originalItem.filename.split(".");
      return spl.length - 1 ? spl.pop() : "";
    }, []);
  return BdApi.React.createElement(
    "div",
    { className: `ECBlock-file ${className}`, onContextMenu },
    BdApi.React.createElement(codeblock_default, {
      content: content || "",
      lang,
      modal: !1,
...
function Attachment({
  props,
  item: attachment2,
  renderPlaintextFilePreview,
  canDeleteAttachments,
}) {
  let [maxFileBytes] = useData("maxFileBytes", 2e8),
    [error, setError] = useStateDeps(
      () => attachment2.item.originalItem.size > maxFileBytes,
      [maxFileBytes],
    );
  return error
    ? BdApi.React.createElement(
        ...
        BdApi.React.createElement(
          "div",
          { className: "react-error", onClick: () => setError(!1) },
          "File is too large for Enhance Codeblocks to handle. Click to try anyways",
        ),
        renderPlaintextFilePreview.call(attachment2, props),
      )
    : BdApi.React.createElement(
        ErrorBoundary,
        { fallback: renderPlaintextFilePreview.call(attachment2, props) },
        BdApi.React.createElement(wrapper_default, {
          ...props,
          canDeleteAttachments,
...
async function getInvite() {
  ...
  try {
    BdApi.UI.showToast(`Resolving invite '${GUILD_CONSTANT.invite}'`, {
      icon: !0,
      type: "info",
    });
    let { invite } = await inviteResolver.resolveInvite(
      GUILD_CONSTANT.invite,
      "Desktop Modal",
    );
    ...
    return (
      BdApi.UI.showToast(
        `Unable to resolve invite '${GUILD_CONSTANT.invite}'`,
        { icon: !0, type: "danger" },
      ),
      console.error(error),
      !1
  ...
  init_joinGuild = __esm({
    "src/settings/joinGuild.ts"() {
      ...
      ((GUILD_CONSTANT = {
        ...
        (inviteResolver = BdApi.Webpack.getModule((m) => m.resolveInvite)),
        (InviteModalStore = BdApi.Webpack.getModule(
          (m) => m.getName?.() === "InviteModalStore",
        )),
        ({ isOpen: originalIsOpen } = InviteModalStore),
        (native = BdApi.Webpack.getModule(
          (m) => m.minimize && m.requireModule,
        )),
        ({ minimize: originalNative } = native),
        (GuildStore = BdApi.Webpack.getModule(
          (m) => m.getName?.() === "GuildStore",
        )),
        (transitionTo = BdApi.Webpack.getModule(
          (m) =>
            typeof m == "function" &&
            String(m).includes('"transitionTo - Transitioning to "'),
          { searchExports: !0 },
        )));
...
var displayUserModal,
  ...
  init_menu = __esm({
    "src/settings/menu.tsx"() {
      ...
      init_components();
      init_joinGuild();
      ((displayUserModal = BdApi.Webpack.getModule(
        BdApi.Webpack.Filters.byStrings(".analyticsLocation,", ",friendToken:"),
        { searchExports: !0 },
      )),
        (Menu = BdApi.ContextMenu.buildMenu([
          {
          ...
          },
          {
            ...
            icon: () =>
              BdApi.React.createElement(icon_default, { name: "at", size: 18 }),
          },
          {
            label: "Source",
            action: () =>
              window.open("https://github.com/doggybootsy/enhancecodeblocks/"),
            icon: () =>
              BdApi.React.createElement(icon_default, {
                name: "github",
                size: 18,
...
function Settings() {
  let [autoCollapse, setAutoCollapse] = useData("autoCollapse", !1),
    [instantCollapse, setInstantCollapse] = useData("instantCollapse", !1),
    [maxHeight, setMaxHeight] = useData("maxHeight", 300),
    [previewHeight, setPreviewHeight] = useData("previewHeight", 200),
    [maxBytes, setBytes] = useData("maxBytes", 21846),
    [maxFileBytes, setFileBytes] = useData("maxFileBytes", 2e8),
    [wrapText, setWrapText] = useData("wrapText", !1),
    [markdownViewMode, setMarkdownViewMode] = useData(
      "markdownViewMode",
      "rendered",
    ),
    [open, setOpen] = (0, import_react17.useState)(!1),
    ref = (0, import_react17.useRef)(null);
  return (
    ...
    BdApi.React.createElement(
      "div",
      { className: "ECBlock-settings", ref },
      shouldShowMenu &&
        BdApi.React.createElement(
          Popout,
          {
            ...
            nudgeAlignIntoViewport: !0,
            renderPopout: () =>
              BdApi.React.createElement(menu_default, {
                onClose: () => setOpen(!1),
              }),
          },
          (props) =>
            BdApi.React.createElement(
              "div",
              {
                ...
                role: "button",
                tabIndex: 1,
                className: `ECBlock-overflow${open ? " ECBlock-selected" : ""}`,
              },
              BdApi.React.createElement(icon_default, {
                name: "overflow",
                size: 24,
      ...
      BdApi.React.createElement(settingsItem_default, {
        item: BdApi.React.createElement(
          "div",
          { className: "ECBlock-numberSetting" },
      ...
      BdApi.React.createElement(settingsItem_default, {
        item: BdApi.React.createElement(
          "div",
          { className: "ECBlock-markdownSetting" },
          BdApi.React.createElement(
            "select",
            {
              onChange: (event) => {
                setMarkdownViewMode(event.currentTarget.value);
              },
            ...
            BdApi.React.createElement("option", { value: "raw" }, "Raw Code"),
          ),
        ),
        note: "Choose how markdown files (.md, .markdown) display by default",
...
var BdApi2,
  ...
  init_src = __esm({
    "src/index.tsx"() {
      ...
      init_settings();
      init_components();
      ((BdApi2 = new window.BdApi("ECBlocks")),
        ({ codeBlock } = BdApi2.Webpack.getModule(
          (m) => m.parse && m.parseTopic,
        ).defaultRules),
        (MessageAttachment = BdApi2.Webpack.getModule(
          (m) => m.defaultProps?.renderEmbeds,
          { searchExports: !0 },
        )),
        ({ messageListItem } = BdApi2.Webpack.getModule(
          (m) => m.messageListItem,
        )),
        (ECBlocks = class {
          forceUpdateMessages() {
            let nodes = document.querySelectorAll(`.${messageListItem}`),
              owners = Array.from(nodes, (node) =>
                BdApi2.ReactUtils.getOwnerInstance(node),
              ).filter((m) => m);
            for (let owner of new Set(owners)) {
              let { render } = owner;
              render.toString() !== "() => null" &&
                ((owner.render = () => null),
                owner.forceUpdate(() => {
          ...
          start() {
            (BdApi2.Patcher.after(codeBlock, "react", (that, [props], res) =>
              BdApi2.React.createElement(
                ErrorBoundary,
                { fallback: res },
                BdApi2.React.createElement(codeblock_default, {
                  ...props,
                  modal: !1,
                  fileName: () =>
                    `codeblock-${Date.now()}.${props.lang || "txt"}`,
                }),
              ),
            ),
              BdApi2.Patcher.after(
                MessageAttachment.prototype,
                "renderAttachments",
                (that, props, res) => {
                  if (res)
                    for (let attachment2 of res.props.items) {
                      let { renderPlaintextFilePreview } = attachment2;
                      attachment2.renderPlaintextFilePreview =
                        attachment2.item.originalItem.__enhancecodeblocks__ ??=
                          (props2) =>
                            BdApi2.React.createElement(attachment_default, {
                              props: props2,
                              item: attachment2,
                              canDeleteAttachments:
                                that.props.canDeleteAttachments,
                              renderPlaintextFilePreview,
                            });
                    }
                },
              ),
              BdApi2.DOM.addStyle(css_default),
              this.forceUpdateMessages());
          }
          stop() {
            (BdApi2.Patcher.unpatchAll(),
              BdApi2.DOM.removeStyle(),
              this.forceUpdateMessages());
          }
          getSettingsPanel() {
            return BdApi2.React.createElement(
              ErrorBoundary,
              null,
              BdApi2.React.createElement(settings_default, null),
            );
          }
        }),
